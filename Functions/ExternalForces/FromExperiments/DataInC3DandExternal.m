...
[external_forces, Knife_Hand] = Add_Knife_Forces(filename, external_forces, BiomechanicalModel, AnalysisParameters);
[external_forces] = Add_Table_Forces(Knife_Hand, filename, external_forces, BiomechanicalModel, AnalysisParameters);
