...
for i_s=1:2
    ...
    if ~isempty(ind1)
        ...
        % (On crée les variables du problème
        % les coordonnées articulaires)
        ...
        % (Calcul de la position du ligament patellaire dans le repère
        % femur)
        ...
        n_bcle=3; % no more variation after 4 decimals (plus de variation après 4 chiffre après la virgule)
        ...
        for ii =1:length(theta_g)
            ...
            % (On crée les fonction qui dependent de theta_p pour les reestimer à
