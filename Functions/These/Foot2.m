function [OsteoArticularModel]= Foot2(OsteoArticularModel,k,Signe,Mass,AttachmentPoint)
% Addition of a foot model
%   This foot model contains one solid (foot), exhibits 2 dof for the ankle
%
%   INPUT
...
% Georges Dumont
%________________________________________________________
list_solid={'Ankle_J1' 'Foot' 'Foot_Toe'};
...
%     [Signe 'FootPrediction14'], k*Mirror*[-0.045;-0.09;0.03]*0.9359;...
    [Signe 'FootPrediction1'], Rota*k*Mirror*[-0.04;0.098;-0.0085]*0.9359;...
    [Signe 'FootPrediction2'], Rota*k*Mirror*[-0.04;0.098;0.012]*0.9359;...
    [Signe 'FootPrediction3'], Rota*k*Mirror*[-0.038;0.067;-0.009]*0.9359;...
    [Signe 'FootPrediction4'], Rota*k*Mirror*[-0.038;0.069;0.011]*0.9359;...
    [Signe 'FootPrediction5'], Rota*k*Mirror*[-0.035;0.033;-0.012]*0.9359;...
    [Signe 'FootPrediction6'], Rota*k*Mirror*[-0.035;0.037;0.016]*0.9359;...
    [Signe 'FootPrediction7'], Rota*k*Mirror*[-0.03;-0.0056;-0.028]*0.9359;...
    [Signe 'FootPrediction8'], Rota*k*Mirror*[-0.03;0.003;0.023]*0.9359;...
    [Signe 'FootPrediction9'], Rota*k*Mirror*[-0.04;-0.05;-0.035]*0.9359;...
    [Signe 'FootPrediction10'], Rota*k*Mirror*[-0.04;-0.049;-0.02]*0.9359;...
    [Signe 'FootPrediction11'], Rota*k*Mirror*[-0.04;-0.046;-0.0062]*0.9359;...
    [Signe 'FootPrediction12'], Rota*k*Mirror*[-0.04;-0.044;0.0074]*0.9359;...
    [Signe 'FootPrediction13'], Rota*k*Mirror*[-0.04;-0.04;0.024]*0.9359;...
    [Signe 'FootPrediction14'], Rota*k*Mirror*[-0.035;-0.087;-0.03]*0.9359;...
    [Signe 'FootPrediction15'], Rota*k*Mirror*[-0.035;-0.087;-0.0093]*0.9359;...
    [Signe 'FootPrediction16'], Rota*k*Mirror*[-0.035;-0.081;0.01]*0.9359;...
    ...
    [Signe 'FootMID'], k*Mirror*[ -0.0182 0.0066 -0.0050]'; ... 
    };
...
%     Human_model(incr_solid).v= [ [1; 0; 0] , [0 ;1;0] ] ;
    ...
    OsteoArticularModel(incr_solid).name=[Signe name];
    OsteoArticularModel(incr_solid).sister=0;    
    OsteoArticularModel(incr_solid).child=s_Foot_Toe;
    ...
    OsteoArticularModel(incr_solid).m=Mass.Foot_Mass*(2/3);
    OsteoArticularModel(incr_solid).b=[0 0 0]';
    OsteoArticularModel(incr_solid).I=(2/3)*[I_Foot(1) I_Foot(4) I_Foot(5); I_Foot(4) I_Foot(2) I_Foot(6); I_Foot(5) I_Foot(6) I_Foot(3)];
    OsteoArticularModel(incr_solid).c=-(2/3)*Foot_AnkleJointNode';
...
OsteoArticularModel(incr_solid).visual_file = ['Anybody/'  Signe 'Foot.mat'];
...
if Signe == 'R'
 ...
 % Foot Toe
    ...
    OsteoArticularModel(incr_solid).mother=s_Foot;
    OsteoArticularModel(incr_solid).a=[0 0 1]';
    OsteoArticularModel(incr_solid).joint=1;
    OsteoArticularModel(incr_solid).u=[0 0 0]';                  % fixed rotation with respect to u axis of theta angle
    OsteoArticularModel(incr_solid).theta=0;
    OsteoArticularModel(incr_solid).limit_inf=-pi/2;
    OsteoArticularModel(incr_solid).limit_sup=pi/2;
    OsteoArticularModel(incr_solid).Visual=1;
    OsteoArticularModel(incr_solid).m=Mass.Foot_Mass*(1/3);
    OsteoArticularModel(incr_solid).b=[0 -k*0.0504 0]'; % metartarse mean position 
    OsteoArticularModel(incr_solid).I=(1/3)*[I_Foot(1) I_Foot(4) I_Foot(5); I_Foot(4) I_Foot(2) I_Foot(6); I_Foot(5) I_Foot(6) I_Foot(3)];
    OsteoArticularModel(incr_solid).c=-(1/3)*Foot_AnkleJointNode';
    OsteoArticularModel(incr_solid).anat_position={};
    %OsteoArticularModel(incr_solid).L={[Signe 'Foot_AnkleJointNode'];[Signe 'Foot_ToetipNode']};
%	Axis of rotation calibration
    %OsteoArticularModel(incr_solid).limit_alpha= [ 30 , 140;...
    %                                      -30, -140]*pi/180 ;
