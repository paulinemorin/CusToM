function [Contact_detection, CoP_Pos] = ContactDetectionSoleSynchPlateforme(filename, AnalysisParameters, Human_model,BiomechanicalModel, p_pelvis, r_pelvis, v0, w, dv0, dw, q, dq, ddq)
%   INPUT
...
% plot(CoP_200')
% hold on
% CoP_200(:,1:start_R-delay_RF-delay_RF_bis)=NaN;
% CoP_200(:,start_R-delay_RF-delay_RF_bis+nbframe-1:end)=NaN;
% plot(CoP_200')
