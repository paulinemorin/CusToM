function [ExternalForcesComputationResults] = ExternalForcesPrediction1_0(filename, AnalysisParameters, BiomechanicalModel, ModelParameters)
...
options = optimoptions(@fmincon,'Algorithm','sqp','Display','final','GradObj','off','GradConstr','off','TolFun',1e-6,'TolX',1e-6,'PlotFcn','optimplotfval');
...
ExternalForcesComputationResults.ExternalForcesPrediction1_0 = external_forces_pred;
