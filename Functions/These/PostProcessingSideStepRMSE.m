...
if contains(filename,'Run')||contains(filename,'Direction')
    ...
    [Event,ID]=DetectRunPhases([char(filename) '_all.c3d'],FootOnPlates);
    
    start_1=ID(1)-ExperimentalData.FirstFrame;
    stop_1=ID(2)-ExperimentalData.FirstFrame;
    ...
    start_2=ID(1)-ExperimentalData.FirstFrame;
    stop_2=ID(2)-ExperimentalData.FirstFrame;
