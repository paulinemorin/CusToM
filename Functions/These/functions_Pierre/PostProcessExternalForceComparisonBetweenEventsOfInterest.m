function []=PostProcessExternalForceComparisonBetweenEventsOfInterest(BiomechanicalModel,AnalysisParameters,filename,FrameOfInterest)
...
for ii=1:3
    subplot(2,3,ii)
    % LFoot
    plot(F_Pred.(Solids{1})(start:stop,ii),'b-','LineWidth',2)
    hold on
    plot(F_Xp.(Solids{1})(start:stop,ii),'b--','LineWidth',2)
    % RFoot
    plot(F_Pred.(Solids{2})(start:stop,ii),'r-','LineWidth',2)
    plot(F_Xp.(Solids{2})(start:stop,ii),'r--','LineWidth',2)
...
for ii=4:6
    subplot(2,3,ii)
    % LFoot
    plot(M_Pred.(Solids{1})(start:stop,ii-3),'b-','LineWidth',2)
    hold on
    plot(M_Xp.(Solids{1})(start:stop,ii-3),'b--','LineWidth',2)
    % RFoot
    plot(M_Pred.(Solids{2})(start:stop,ii-3),'r-','LineWidth',2)
    plot(M_Xp.(Solids{2})(start:stop,ii-3),'r--','LineWidth',2)
