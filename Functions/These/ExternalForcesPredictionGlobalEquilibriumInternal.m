function [ExternalForcesComputationResults] = ExternalForcesPredictionGlobalEquilibriumInternal(filename, AnalysisParameters, BiomechanicalModel, ModelParameters)
