function [ExternalForcesComputationResults] = ExternalForcesPredictionCOP(filename, AnalysisParameters, BiomechanicalModel, ModelParameters)
...
%     0.0887
%    -0.0010];
%X = [11.3747397458608;-5.48456262160755;-2.73124809182205;-0.0853110955082871;0.0374054432207678;0.0234137174512044;-10.3726939152349;4.90727178560408;-4.88582915090524;-0.0808286062337511;0.0516912885983848;-0.00352318213991717];

load(fullfile(filename,'InsoleData.mat'))
X=InsoleData.X;
[COP_Xp, Contact_detection] = COP_Xp_f(filename,X);
PositionCoP = CoPInsoleGlob(X,filename);
...
for i=1:nbframe
    ...
    for pred = 1:numel(Prediction)
        ...
        %
        Activ_Contact_Point_g = Contact_detection(1,i);
        Activ_Contact_Point_d = Contact_detection(2,i);
