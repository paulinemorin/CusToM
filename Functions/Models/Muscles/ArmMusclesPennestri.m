...
s=[s;{
    ...
    [Signe 'Anconeus'],350,0.027,[],[],[],{[Signe 'Humerus_Anconeus_o'];[Signe 'Ulna_Anconeus_i']},{};...
    [Signe 'FlexorCarpiUlnaris'],128.9,0.051,[],[],[],{[Signe 'Humerus_FlexorCarpiUlnaris_o'];[Signe 'Hand_FlexorCarpiUlnaris_i']},{};...
    [Signe 'ExtensorCarpiUlnaris'],93.2,0.062,[],[],[],{[Signe 'Humerus_ExtensorCarpiUlnaris_o'];[Signe 'Hand_ExtensorCarpiUlnaris_i']},{};...
   [Signe 'ExtensorCarpiRadialisLongus'],304.9,0.081,[],0.244,[],{[Signe 'Humerus_ExtensorCarpiRadialisLongus_o'];[Signe 'Hand_ExtensorCarpiRadialisLongus_i']},{};...
    [Signe 'ExtensorCarpiRadialisBrevis'],100.5,0.059,[],0.2223,[],{[Signe 'Humerus_ExtensorCarpiRadialisBrevis_o'];[Signe 'Hand_ExtensorCarpiRadialisBrevis_i']},{};...
    [Signe 'FlexorCarpiRadialis'],74,0.063,[],[],[],{[Signe 'Humerus_FlexorCarpiRadialis_o'];[Signe 'Hand_FlexorCarpiRadialis_i']},{};...
    [Signe 'PronatorQuadratus'],75.5,0.028,[],[],[],{[Signe 'Radius_PronatorQuadratus_o'];[Signe 'Ulna_PronatorQuadratus_i']},{};...
    [Signe 'SupinatorBrevis'],476,0.033,[],[],[],{[Signe 'Radius_SupinatorBrevis_o'];[Signe 'Ulna_SupinatorBrevis_i']},{};...
    [Signe 'Brachialis'],987.3,0.086,4,0.0535,0,{[Signe 'Humerus_Brachialis_o'];[Signe 'Ulna_Brachialis_i']},{};...
    [Signe 'Brachioradialis'],261.3,0.173,[],[],[],{[Signe 'Humerus_Brachioradialis_o'];[Signe 'Radius_Brachioradialis_i']},{};...
    [Signe 'PronatorTeres'],566.2,0.049,[],[],[],{[Signe 'Humerus_PronatorTeres_o'];[Signe 'Radius_PronatorTeres_i']},{};...
    [Signe 'TricepsLat'],624.3,0.114,4,0.098,0.157,{[Signe 'Humerus_TricepsLat_o'];[Signe 'Ulna_TricepsLat_i']},{};... 
    [Signe 'TricepsMed'],624.3,0.114,4,0.098,0.157,{[Signe 'Humerus_TricepsMed_o'];[Signe 'Ulna_TricepsMed_i']},{};... arm26.osim
    [Signe 'PalmarisLongus'],26.7,0.064,4,0.098,0.157,{[Signe 'Humerus_PalmarisLongus_o'];[Signe 'Hand_PalmarisLongus_i']},{};...
