...
% Elbow
s=[s;{
    [Signe 'Brachioradialis'],261.3,0.22,[],[],[],{[Signe 'Humerus_Brachioradialis_o'];[Signe 'Forearm_Brachioradialis_i']},{};...
    ...
    [Signe 'ExtensorCarpiRadialisLongus'],304.9,0.081,[],0.244,[],{[Signe 'Humerus_ExtensorCarpiRadialisLongus_o'];[Signe 'Hand_ExtensorCarpiRadialisLongus_i']},{};...
    ...
    [Signe 'ExtensorCarpiRadialisBrevis'],252.5,0.0585,[],0.2223,[],{[Signe 'Humerus_ExtensorCarpiRadialisBrevis_o'];[Signe 'Hand_ExtensorCarpiRadialisBrevis_i']},{};...
    [Signe 'FlexorCarpiRadialis'],74,0.235,[],[],[],{[Signe 'Humerus_FlexorCarpiRadialis_o'];[Signe 'Hand_FlexorCarpiRadialis_i']},{};...
    [Signe 'PronatorTeres'],566.2,0.07,[],[],[],{[Signe 'Humerus_PronatorTeres_o'];[Signe 'Forearm_PronatorTeres_i']},{};...
