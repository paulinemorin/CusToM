...
%     
   [Signe 'Anconeus'],350,0.027,[],[],[],{[Signe 'Humerus_AnconeusBO_o'];[Signe 'Humerus_AnconeusBO_VP1'];[Signe 'Ulna_Anconeus_VP2'];[Signe 'Ulna_Anconeus_i']},{};...
   [Signe 'FlexorCarpiUlnaris'],128.9,0.051,[],[],[],{[Signe 'Humerus_FlexorCarpiUlnarisBO_o'];[Signe 'Humerus_FlexorCarpiUlnarisBO_VP1'];[Signe 'Radius_FlexorCarpiUlnaris_VP2'];[Signe 'Radius_FlexorCarpiUlnaris_VP3'];[Signe 'Hand_FlexorCarpiUlnarisBO_VP4'];[Signe 'Hand_FlexorCarpiUlnarisBO_i']},{};...
   [Signe 'ExtensorCarpiUlnaris'],93.2,0.062,[],[],[],{[Signe 'Humerus_ExtensorCarpiUlnarisBO_o'];[Signe 'Humerus_ExtensorCarpiUlnarisBO_VP1'];[Signe 'Radius_ExtensorCarpiUlnaris_VP2'];[Signe 'Radius_ExtensorCarpiUlnaris_VP3'];[Signe 'Hand_ExtensorCarpiUlnarisBO_VP4'];[Signe 'Hand_ExtensorCarpiUlnarisBO_i']},{};...
   [Signe 'ExtensorCarpiRadialisLongus'],304.9,0.081,[],0.244,[],{[Signe 'Humerus_ExtensorCarpiRadialisLongusBO_o'];[Signe 'Humerus_ExtensorCarpiRadialisLongusBO_VP1'];[Signe 'Radius_ExtensorCarpiRadialisLongus_VP2'];[Signe 'Radius_ExtensorCarpiRadialisLongus_VP3'];[Signe 'Hand_ExtensorCarpiRadialisLongusBO_VP4'];[Signe 'Hand_ExtensorCarpiRadialisLongusBO_i']},{};...
   [Signe 'ExtensorCarpiRadialisBrevis'],100.5,0.059,[],0.2223,[],{[Signe 'Humerus_ExtensorCarpiRadialisBrevisBO_o'];[Signe 'Humerus_ExtensorCarpiRadialisBrevisBO_VP1'];[Signe 'Radius_ExtensorCarpiRadialisBrevis_VP2'];[Signe 'Radius_ExtensorCarpiRadialisBrevis_VP3'];[Signe 'Hand_ExtensorCarpiRadialisBrevisBO_VP4'];[Signe 'Hand_ExtensorCarpiRadialisBrevisBO_i']},{};...
   [Signe 'FlexorCarpiRadialis'],74,0.063,[],[],[],{[Signe 'Humerus_FlexorCarpiRadialisBO_o'];[Signe 'Humerus_FlexorCarpiRadialisBO_VP1'];[Signe 'Radius_FlexorCarpiRadialis_VP2'];[Signe 'Radius_FlexorCarpiRadialis_VP3'];[Signe 'Hand_FlexorCarpiRadialisBO_VP4'];[Signe 'Hand_FlexorCarpiRadialisBO_i']},{};...
   [Signe 'Brachialis'],987.3,0.086,4,0.0535,0,{[Signe 'Humerus_BrachialisBO_o'];[Signe 'Humerus_BrachialisBO_VP1'];[Signe 'Ulna_Brachialis_VP2'];[Signe 'Ulna_Brachialis_i']},{};...
   [Signe 'Brachioradialis'],261.3,0.173,[],[],[],{[Signe 'Humerus_BrachioradialisBO_o'];[Signe 'Humerus_BrachioradialisBO_VP1'];[Signe 'Radius_Brachioradialis_VP2'];[Signe 'Radius_Brachioradialis_i']},{};...
   [Signe 'PronatorTeres'],566.2,0.049,[],[],[],{[Signe 'Humerus_PronatorTeresBO_o'];[Signe 'Humerus_PronatorTeresBO_VP1'];[Signe 'Radius_PronatorTeres_VP2'];[Signe 'Radius_PronatorTeres_i']},{};...
   [Signe 'TricepsLat'],624.3,0.114,4,0.098,0.157,{[Signe 'Humerus_TricepsLatBO_o'];[Signe 'Humerus_TricepsLatBO_VP1'];[Signe 'Ulna_TricepsLat_VP2'];[Signe 'Ulna_TricepsLat_i']},{};... 
   [Signe 'TricepsMed'],624.3,0.114,4,0.098,0.157,{[Signe 'Humerus_TricepsMedBO_o'];[Signe 'Humerus_TricepsMedBO_VP1'];[Signe 'Ulna_TricepsMed_VP2'];[Signe 'Ulna_TricepsMed_i']},{};... arm26.osim
   [Signe 'PalmarisLongus'],26.7,0.064,4,0.098,0.157,{[Signe 'Humerus_PalmarisLongusBO_o'];[Signe 'Humerus_PalmarisLongusBO_VP1'];[Signe 'Radius_PalmarisLongus_VP2'];[Signe 'Radius_PalmarisLongus_VP3'];[Signe 'Hand_PalmarisLongusBO_VP4'];[Signe 'Hand_PalmarisLongusBO_i']},{};...
...
%     [Signe 'PalmarisLongus'],26.7,0.064,4,0.098,0.157,{[Signe 'Humerus_PalmarisLongus_o'];[Signe 'Humerus_PalmarisLongus_VP1'];[Signe 'Radius_PalmarisLongus_VP2'];[Signe 'Radius_PalmarisLongus_VP3'];[Signe 'Hand_PalmarisLongus_VP4'];[Signe 'Hand_PalmarisLongus_i']},{};...
     ...
     [Signe 'TricepsLg'],798.5,0.134,4,0.143,0.209,{[Signe 'Scapula_Triceps_o'];[Signe 'Humerus_TricepsLg_via1'];[Signe 'Humerus_Triceps_via2'];[Signe 'Humerus_TricepsMedBO_VP1'];[Signe 'Ulna_TricepsMed_VP2'];[Signe 'Ulna_TricepsMed_i']},{};...       arm26.osim    
