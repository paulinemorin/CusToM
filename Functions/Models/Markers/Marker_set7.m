function [Markers]=Marker_set7(nb_markers_hand)
% Definition of the markers set used in the M2S
% fencing version Left handed
%
%   INPUT
...
for i=1:2
    ...
    s=[s;{[Signe 'HUM'] [Signe 'HUM'] {'Off';'Off';'Off'};[Signe 'RAD'] [Signe 'RAD'] {'On';'On';'Off'};...
        [Signe 'WRA'] [Signe 'WRA'] {'Off';'Off';'Off'};[Signe 'WRB'] [Signe 'WRB'] {'Off';'On';'Off'};...
        'Root1' [Signe 'CAR1'] {'Off';'On';'Off'}}]; %#ok<AGROW>
    else
         s=[s;{[Signe 'HUM'] [Signe 'HUM'] {'Off';'Off';'Off'};[Signe 'RAD'] [Signe 'RAD'] {'On';'On';'Off'};...
        [Signe 'WRA'] [Signe 'WRA'] {'Off';'Off';'Off'};[Signe 'WRB'] [Signe 'WRB'] {'Off';'On';'Off'};...
        [Signe 'CAR'] [Signe 'CAR1'] {'Off';'On';'Off'}}]; %#ok<AGROW>
    end
end
