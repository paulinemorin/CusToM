...
%         [Signe 'Humerus_ExtensorCarpiRadialisBrevis_o'],Mirror*osim2antoine'.*([0.01349;-0.29048;0.01698])+Humerus_ghJointNode';...
   ...
   [Signe 'Humerus_TricepsLatBF_VP1'], k*Mirror*[-0.0193 ; -0.1464 ; -0.0139];... 
    ...
    [Signe 'Humerus_AnconeusBO_o'], k*Mirror*[-0.0130 ; -0.1605 ; 0.0091] ;  ... 
    [Signe 'Humerus_AnconeusBO_VP1'], k*Mirror*[-0.0154 ; -0.1608 ; 0.0087];... 
    
    [Signe 'Humerus_BrachialisBO_o'], k*Mirror*[0.0075 ; -0.0542 ; -0.0029];... 
    [Signe 'Humerus_BrachialisBO_VP1'], k*Mirror*[0.0104 ; -0.1444 ; 0.0000];... 
    
    [Signe 'Humerus_TricepsMedBO_o'],  k*Mirror*[-0.0088 ; -0.0046 ; -0.0082] ;... 
    [Signe 'Humerus_TricepsMedBO_VP1'], k*Mirror*[-0.0129 ; -0.1419 ; 0.0001];... 
    
    [Signe 'Humerus_TricepsLatBO_o'],k*Mirror*[-0.0065 ; 0.0085 ; 0.0039] ;... 
   [Signe 'Humerus_TricepsLatBO_VP1'], k*Mirror*[-0.0127 ; -0.1418 ; -0.0001];... 
