...
%         [Signe 'Humerus_ExtensorCarpiRadialisBrevis_o'],Mirror*osim2antoine'.*([0.01349;-0.29048;0.01698])+Humerus_ghJointNode';...
    ...
    [Signe 'Humerus_BrachioradialisBF_o'], k*Mirror*[-0.0096 ; -0.0626 ; 0.0126];... 
    [Signe 'Humerus_BrachioradialisBF_VP1'], k*Mirror*[-0.0031 ; -0.0692 ; 0.0419];... 
    [Signe 'Humerus_ExtensorCarpiRadialisLongusBF_o'], k*Mirror*[-0.0005 ; -0.1404 ; 0.0254];... 
    [Signe 'Humerus_ExtensorCarpiRadialisLongusBF_VP1'], k*Mirror*[-0.0022 ; -0.1404 ; 0.0420] ;... 
    [Signe 'Humerus_ExtensorCarpiRadialisBrevisBF_o'],  k*Mirror*[0.0066 ; -0.1698 ; -0.0415] ;... 
    [Signe 'Humerus_ExtensorCarpiRadialisBrevisBF_VP1'], k*Mirror*[0.0066 ; -0.1698 ; -0.0415];... 
    [Signe 'Humerus_ExtensorCarpiUlnarisBF_o'], k*Mirror*[-0.0113 ; -0.1601 ; 0.0586];... 
    [Signe 'Humerus_ExtensorCarpiUlnarisBF_VP1'], k*Mirror*[-0.0061 ; -0.1706 ; 0.0338] ;... 
    [Signe 'Humerus_FlexorCarpiUlnarisBF_o'], k*Mirror*[0.0022 ; -0.1526 ; -0.0333] ;... 
    [Signe 'Humerus_FlexorCarpiUlnarisBF_VP1'], k*Mirror*[0.0031 ; -0.1526 ; -0.0355];... 
    [Signe 'Humerus_FlexorCarpiRadialisBF_o'], k*Mirror*[0.0077 ; -0.1529 ; -0.0377];... 
    [Signe 'Humerus_FlexorCarpiRadialisBF_VP1'],  k*Mirror*[0.0067 ; -0.1542 ; -0.0323] ;... 
    [Signe 'Humerus_PalmarisLongusBF_o'], k*Mirror*[0.0058 ; -0.1497 ; -0.0464];... 
    [Signe 'Humerus_PalmarisLongusBF_VP1'], k*Mirror*[0.0035 ; -0.1502 ; -0.0333];... 
    [Signe 'Humerus_PronatorTeresBF_o'], k*Mirror*[0.0064 ; -0.1530 ; -0.0008] ;... 
    [Signe 'Humerus_PronatorTeresBF_VP1'], k*Mirror*[0.0097 ; -0.1556 ; 0.0409];... 
    [Signe 'Humerus_AnconeusBF_o'], k*Mirror*[-0.0158 ; -0.1616 ; -0.0011];... 
    [Signe 'Humerus_AnconeusBF_VP1'], k*Mirror*[-0.0157 ; -0.1622 ; -0.0041];... 
    [Signe 'Humerus_BrachialisBF_o'], k*Mirror*[0.0042 ; -0.0442 ; -0.0047];... 
    [Signe 'Humerus_BrachialisBF_VP1'], k*Mirror*[0.0125 ; -0.1454 ; -0.0138];... 
    [Signe 'Humerus_TricepsMedBF_o'],  k*Mirror*[-0.0103 ; 0.0032 ; -0.0087] ;... 
    [Signe 'Humerus_TricepsMedBF_VP1'], k*Mirror*[-0.0194 ; -0.1465 ; -0.0139];... 
    [Signe 'Humerus_TricepsLatBF_o'],k*Mirror*[-0.0072 ; 0.0155 ; 0.0038];... 
   [Signe 'Humerus_TricepsLatBF_VP1'], k*Mirror*[-0.0193 ; -0.1464 ; -0.0139];... 
   
   
     [Signe 'Humerus_BrachioradialisBO_o'], k*Mirror*[-0.0088 ; -0.0629 ; 0.0035];... 
    [Signe 'Humerus_BrachioradialisBO_VP1'], k*Mirror*[-0.0026 ; -0.0637 ; 0.0108];... 
    
    [Signe 'Humerus_ExtensorCarpiRadialisLongusBO_o'], k*Mirror*[-0.0027 ; -0.1334 ; 0.0217] ;... 
    [Signe 'Humerus_ExtensorCarpiRadialisLongusBO_VP1'], k*Mirror*[-0.0013 ; -0.1334 ; 0.0255] ;... 
    
    [Signe 'Humerus_ExtensorCarpiRadialisBrevisBO_o'],  k*Mirror*[0.0062 ; -0.1686 ; 0.0107] ;... 
    [Signe 'Humerus_ExtensorCarpiRadialisBrevisBO_VP1'], k*Mirror*[0.0062 ; -0.1686 ; 0.0107];... 
    
    [Signe 'Humerus_ExtensorCarpiUlnarisBO_o'], k*Mirror*[-0.0082 ; -0.1674 ; 0.0412] ;... 
    [Signe 'Humerus_ExtensorCarpiUlnarisBO_VP1'], k*Mirror*[-0.0082 ; -0.1674 ; 0.0413];... 
    
    [Signe 'Humerus_FlexorCarpiUlnarisBO_o'], k*Mirror*[0.0024 ; -0.1531 ; -0.0404]  ;... 
    [Signe 'Humerus_FlexorCarpiUlnarisBO_VP1'], k*Mirror*[0.0026 ; -0.1537 ; -0.0418];... 
    
    [Signe 'Humerus_FlexorCarpiRadialisBO_o'], k*Mirror*[0.0069 ; -0.1536 ; -0.0385];... 
    [Signe 'Humerus_FlexorCarpiRadialisBO_VP1'],  k*Mirror*[0.0058 ; -0.1545 ; -0.0412] ;... 
    
    [Signe 'Humerus_PalmarisLongusBO_o'], k*Mirror*[0.0052 ; -0.1494 ; -0.0377];... 
    [Signe 'Humerus_PalmarisLongusBO_VP1'], k*Mirror*[0.0025 ; -0.1513 ; -0.0420];... 
    
    [Signe 'Humerus_PronatorTeresBO_o'], k*Mirror*[0.0037 ; -0.1514 ; -0.0385]  ;... 
    [Signe 'Humerus_PronatorTeresBO_VP1'], k*Mirror*[0.0039 ; -0.1526 ; -0.0419];... 
    
    [Signe 'Humerus_AnconeusBO_o'], k*Mirror*[-0.0271 ; -0.1597 ; 0.0011] ;  ... 
    [Signe 'Humerus_AnconeusBO_VP1'], k*Mirror*[-0.0295 ; -0.1597 ; 0.0000];... 
    
    [Signe 'Humerus_BrachialisBO_o'], k*Mirror*[0.0075 ; -0.0542 ; -0.0029];... 
    [Signe 'Humerus_BrachialisBO_VP1'], k*Mirror*[0.0104 ; -0.1444 ; 0.0000];... 
    
    [Signe 'Humerus_TricepsMedBO_o'],  k*Mirror*[-0.0113 ; -0.0117 ; -0.0077] ;... 
    [Signe 'Humerus_TricepsMedBO_VP1'], k*Mirror*[-0.0285 ; -0.1350 ; 0.000];... 
    
    [Signe 'Humerus_TricepsLatBO_o'],k*Mirror*[-0.0089 ; 0.0011 ; 0.0037] ;... 
   [Signe 'Humerus_TricepsLatBO_VP1'], k*Mirror*[-0.0285 ; -0.1350 ; 0.0000];... 
