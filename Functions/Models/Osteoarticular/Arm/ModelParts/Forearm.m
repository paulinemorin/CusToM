...
%  
        ...
        [Signe 'Radius_PronatorTeres_i'], k*Mirror*[0.0304 ; -0.0082 ; 0.0107] ;...
         ...
         [Signe 'Ulna_Anconeus_VP2'], k*Mirror*[-0.0247 ; 0.1217 ; -0.0056];...
         [Signe 'Ulna_Anconeus_i'], k*Mirror*[-0.0249 ; 0.1208 ; -0.0079];...
       
         [Signe 'Ulna_Brachialis_VP2'], k*Mirror*[0.0055 ; 0.0955 ; 0.0000];...
        [Signe 'Ulna_Brachialis_i'], k*Mirror*[-0.0016 ; 0.0939 ; -0.0147] ;...
        
        [Signe 'Ulna_TricepsMed_VP2'], k*Mirror*[-0.0139 ; 0.1425 ; 0.0002];...
        [Signe 'Ulna_TricepsMed_i'], k*Mirror*[-0.0212 ; 0.1329 ; -0.0180];...
       
        [Signe 'Ulna_TricepsLat_VP2'], k*Mirror*[-0.0138 ; 0.1426 ; 0.0000];... 
        [Signe 'Ulna_TricepsLat_i'], k*Mirror*[-0.0212 ; 0.1327 ; -0.0183] ;...
