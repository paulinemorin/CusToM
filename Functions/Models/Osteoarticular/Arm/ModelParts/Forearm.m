...
Forearm_position_set= {...
    ...
    [Signe 'Forearm_PronatorTeres_i'], (k*Mirror*[0 -0.15 0.048]'+(Humerus_ghJointNode+Humerus_RadiusJointNode)')/2; ... milieu epidondyle-styloid lat
     ...
     [Signe 'Radius_Biceps_i'],Mirror*Forearm_osim2antoine'.*([-0.002;-0.0375;-0.002])+ Radius_origin + Radius_Ulna_distal'   + RadiusJointNode'+ Forearm_ElbowJointNode';...
% 
%      
...
%  
        ...
        % From moment arm optimization

        
        [Signe 'Radius_Brachioradialis_VP2'], k*Mirror*[0.0223 ; 0.0181 ; 0.0087];...
        [Signe 'Radius_Brachioradialis_i'], k*Mirror*[0.0394 ; -0.1164 ; 0.0212];...
        
        [Signe 'Radius_ExtensorCarpiRadialisLongus_VP2'], k*Mirror*[0.0059 ; 0.0653 ; 0.0069];...
        [Signe 'Radius_ExtensorCarpiRadialisLongus_VP3'], k*Mirror*[-0.0192 ; -0.1110 ; 0.0338];...
        
        [Signe 'Radius_ExtensorCarpiRadialisBrevis_VP2'], k*Mirror*[0.0190 ; 0.0185 ; 0.0076] ;...
        [Signe 'Radius_ExtensorCarpiRadialisBrevis_VP3'], k*Mirror*[-0.0372 ; 0.0109 ; 0.0107];...
        
        [Signe 'Radius_ExtensorCarpiUlnaris_VP2'], k*Mirror*[0.0021 ; -0.1210 ; 0.0164] ;...
        [Signe 'Radius_ExtensorCarpiUlnaris_VP3'], k*Mirror*[-0.0008 ; -0.1211 ; -0.0279] ;...
        
        [Signe 'Radius_FlexorCarpiUlnaris_VP2'], k*Mirror*[0.0039 ; 0.0161 ; -0.0106];...
        [Signe 'Radius_FlexorCarpiUlnaris_VP3'], k*Mirror*[0.0331 ; -0.1310 ; -0.0204];...
        
        [Signe 'Radius_FlexorCarpiRadialis_VP2'], k*Mirror*[0.0177 ; -0.0860 ; -0.0230] ;... 
        [Signe 'Radius_FlexorCarpiRadialis_VP3'], k*Mirror*[0.0375 ; -0.1403 ; 0.0101] ;...
        
        [Signe 'Radius_PalmarisLongus_VP2'], k*Mirror*[0.0223 ; -0.1038 ; -0.0293] ;...
        [Signe 'Radius_PalmarisLongus_VP3'], k*Mirror*[0.0383 ; -0.1426 ; 0.0070] ;...
       
        [Signe 'Radius_PronatorTeres_VP2'], k*Mirror*[0.0383 ; 0.0019 ; -0.0065] ;...
        [Signe 'Radius_PronatorTeres_i'], k*Mirror*[0.0304 ; -0.0082 ; 0.0107] ;...
  
        
         [Signe 'Ulna_Anconeus_VP2'], k*Mirror*[-0.0136 ; 0.1189 ; 0.0000];...
         [Signe 'Ulna_Anconeus_i'], k*Mirror*[-0.0149 ; 0.1189 ; -0.0014];...
       
         [Signe 'Ulna_Brachialis_VP2'], k*Mirror*[0.0055 ; 0.0955 ; 0.0000];...
        [Signe 'Ulna_Brachialis_i'], k*Mirror*[-0.0016 ; 0.0939 ; -0.0147] ;...
        
        [Signe 'Ulna_TricepsMed_VP2'], k*Mirror*[-0.0235 ; 0.1319 ; 0.0000];...
        [Signe 'Ulna_TricepsMed_i'], k*Mirror*[-0.0221 ; 0.1319 ; -0.0170];...
       
        [Signe 'Ulna_TricepsLat_VP2'], k*Mirror*[-0.0234 ; 0.1319 ; 0.0000];... 
        [Signe 'Ulna_TricepsLat_i'], k*Mirror*[-0.0221 ; 0.1319 ; -0.0173] ;...
...
%% Forearm
    ...
    OsteoArticularJoint(incr_solid).density=1.13; %kg.L-1
