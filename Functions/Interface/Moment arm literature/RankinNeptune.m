function [MomentsArm,RegressionStructure]=RankinNeptune(mus_name,axis,joints_names,q)
% Computing of moment arm as a function of q and giving
% regression structure for moment arm
%
...
if strcmp(mus_name,'TricepsLg')
    ...
    elseif strcmp(axis,'GH axial rotation')
        ...
        if ~isempty(ind1) && ~isempty(ind2) && ~isempty(ind3)
            ...
            MomentsArm = equationRRN13(coeffs,Q);
        end
    end
end
...
if strcmp(mus_name,'Coracobrachialis')
    if strcmp(axis,'GH plane of elevation')
        ...
        if ~isempty(ind1) && ~isempty(ind2) && ~isempty(ind3)
            ...
            MomentsArm = equationRRN5(coeffs,Q);
        end
...
if strcmp(mus_name,'BicepsS')
    if strcmp(axis,'GH plane of elevation')
        ...
        if ~isempty(ind1) && ~isempty(ind2) && ~isempty(ind3)
            ...
            MomentsArm = equationRRN6(coeffs,Q);
        end
    elseif strcmp(axis,'Negative GH elevation angle')
        [~,ind1] = intersect(joints_names,{'GH plane of elevation'});
        [~,ind2] = intersect(joints_names,{'Negative GH elevation angle'});
    ...
    elseif strcmp(axis,'GH axial rotation')
        ...
        if ~isempty(ind1) && ~isempty(ind2) && ~isempty(ind3)
            Q  = q([ind1,ind2,ind3],:)';
            coeffs=[0.00421372975769216,0.00132479311140787,-0.00652360135035131,-0.00225227525609336,-0.00313823371589950,0.000538658356048545,0.00192173964710165,0.00722323629630867,-0.00166647694422093,-0.000113179848459099,0.000325960114303425,-0.00437717913248256,0.00425664421087765,5.49884140016813e-05,0.000323634941972235,-0.000695557454079626,0.000998932164343572,0.000914084300285640,-0.00154584069319785,-0.000646116861632924,-0.000595993250427194,0.000810688184138797]';            MomentsArm = equationRRN12(coeffs,Q);
        end
...
if strcmp(mus_name,'BicepsL')
    if strcmp(axis,'GH plane of elevation')
        ...
        if ~isempty(ind1) && ~isempty(ind2) && ~isempty(ind3)
            ...
            MomentsArm = equationRRN8(coeffs,Q);
        end
    elseif strcmp(axis,'Negative GH elevation angle')
        [~,ind1] = intersect(joints_names,{'GH plane of elevation'});
        [~,ind2] = intersect(joints_names,{'Negative GH elevation angle'});
...
if strcmp(mus_name,'Deltoid_pos')
    if strcmp(axis,'GH plane of elevation')
        ...
        if ~isempty(ind1) && ~isempty(ind2) && ~isempty(ind3)
            ...
            MomentsArm = equationRRN7(coeffs,Q);
        end
    elseif strcmp(axis,'Negative GH elevation angle')
        [~,ind1] = intersect(joints_names,{'GH plane of elevation'});
        [~,ind2] = intersect(joints_names,{'Negative GH elevation angle'});
        ...
        if ~isempty(ind1) && ~isempty(ind2) && ~isempty(ind3)
            ...
            MomentsArm = equationRRN9(coeffs,Q);
        end
    elseif strcmp(axis,'GH axial rotation')
        [~,ind1] = intersect(joints_names,{'GH plane of elevation'});
        [~,ind2] = intersect(joints_names,{'Negative GH elevation angle'});
...
if strcmp(mus_name,'Deltoid_ant')
    if strcmp(axis,'GH plane of elevation')
        ...
        if ~isempty(ind1) && ~isempty(ind2) && ~isempty(ind3)
            ...
            MomentsArm = equationRRN11(coeffs,Q);
        end
    elseif strcmp(axis,'Negative GH elevation angle')
        [~,ind1] = intersect(joints_names,{'GH plane of elevation'});
        [~,ind2] = intersect(joints_names,{'Negative GH elevation angle'});
...
if strcmp(mus_name,'Infraspinatus')
    if strcmp(axis,'GH plane of elevation')
        ...
        if ~isempty(ind1) && ~isempty(ind2) && ~isempty(ind3)
           ...
           MomentsArm = equationRRN10(coeffs,Q);
        end
    elseif strcmp(axis,'Negative GH elevation angle')
        [~,ind1] = intersect(joints_names,{'GH plane of elevation'});
        [~,ind2] = intersect(joints_names,{'Negative GH elevation angle'});
